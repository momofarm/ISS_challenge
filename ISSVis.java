...
for ( int lon = 0 ; lon < 4 ; lon ++ )
   ...
   if ( shadow_fraction > 1.0 ) 
      shadow_fraction = 1.0 ; // fix tiny round off error
...
// ************************************************************
static boolean match ( String [] s , int i , String pat ) 
// ************************************************************
{
if ( pat.startsWith(s[i]) ) return true ;
if ( ("-"+pat).startsWith(s[i]) ) return true ;
if ( ("--"+pat).startsWith(s[i]) ) return true ;
return false ;
} ;
// ************************************************************
static boolean matcha ( String [] s , int i , String pat ) 
// ************************************************************
{
if ( ( pat.startsWith(s[i]) ||
       ("-"+pat).startsWith(s[i]) ||
       ("--"+pat).startsWith(s[i]) ) &&
     i < s.length -1 &&
     ! s[i+1].startsWith("-") ) 
...
if ( ( pat.startsWith(s[i]) ||
       ...
       ("--"+pat).startsWith(s[i]) ) )
   {
   System.err.println ( "Error: option -" + pat + 
...
// ************************************************************
static boolean matchd ( String [] s , int i , String pat ) 
// ************************************************************
{
if ( ( pat.startsWith(s[i]) ||
       ("-"+pat).startsWith(s[i]) ||
   ...
   try
      ...
      {
      System.err.println ( "Double argument reqired for option " + 
                           s[i] + " found: " + s[i+1] ) ;
      System.exit(3) ;
      }
   }
...
// ************************************************************
static boolean matchi ( String [] s , int i , String pat ) 
// ************************************************************
{
if ( ( pat.startsWith(s[i]) ||
       ("-"+pat).startsWith(s[i]) ||
   ...
   try
      ...
      {
      System.err.println ( "Integer argument reqired for option " + 
                           s[i] + " found: " + s[i+1] ) ;
      System.exit(3) ;
      }
   }
...
try
   ...
   for ( int a = 0 ; a < arg.length ; a++ )
      {
      if ( matcha ( arg , a , "exec") )
         {
         cmd = arg[++a] ;
         }
      else if ( matchd ( arg , a , "beta") )
         {
         beta = Double.parseDouble ( arg[++a] ) ;
         }
      else if ( matchd ( arg , a , "view_alpha") )
         {
         view_alpha = Double.parseDouble ( arg[++a] ) ;
         }
      else if ( matchd ( arg , a , "view_beta") )
         {
         view_beta = Double.parseDouble ( arg[++a] ) ;
         }
      else if ( matchi ( arg , a , "frames") )
         {
         max_frame = Integer.parseInt ( arg[++a] ) ;
         }
      else if ( matchi ( arg , a , "resolution") )
         {
         res = Integer.parseInt ( arg[++a] ) ;
         }
      else if ( matchi ( arg , a , "subsamples") )
         {
      ...
      else if ( matcha ( arg , a , "csv") )
         {
         csvname = arg[++a] ;
         }
      else if ( matcha ( arg , a , "model") )
         {
         mfile = arg[++a] ;
         }
      else
